...
def parse_command_section(content: str, group: str | None = None) -> list[ParsedCommand]:
...
def _try_colon(lines: list[str], group: str | None) -> list[ParsedCommand]:
...
def _try_csv(lines: list[str], group: str | None) -> list[ParsedCommand]:
